...
export const LBCLMM_PROGRAM_IDS = {
  devnet: "7PAPPM8tAPuhAmBsa7kbTcXNA6xXK3skXLdJLZ72sqZW",
  localhost: "7PAPPM8tAPuhAmBsa7kbTcXNA6xXK3skXLdJLZ72sqZW",
...
export const MAX_BIN_ARRAY_SIZE = new BN(
  CONSTANTS.find(([k, v]) => v.name == "MAX_BIN_PER_ARRAY")?.[1].value ?? 70,
);
